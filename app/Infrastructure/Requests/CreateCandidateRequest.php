...
class CreateCandidateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'skills.*.proficiency'                                       => 'required|numeric|min:0|max:10',
            ...
            'languages.*.proficiency'                                    => 'required|numeric|min:0|max:10',
            ...
            'contact_info.phone_number1'                                 => 'nullable|string|max:20',
            'contact_info.phone_number2'                                 => 'nullable|string|max:20',
            'contact_info.whatsapp_number'                               => 'nullable|string|max:20',
            'contact_info.email1'                                        => 'nullable|email|max:255',
            'contact_info.email2'                                        => 'nullable|email|max:255',
